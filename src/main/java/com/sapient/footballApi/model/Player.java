...
public class Player {
     ...
     * 
     * @param playerNumber
     * @param playerRedCards
     * @param playerKey
     * @param playerAge
     * @param playerName
     * @param playerYellowCards
     * @param playerType
     * @param playerMatchPlayed
     * @param playerCountry
     * @param playerGoals
     */
    public Player(long playerKey, String playerName, String playerNumber, String playerCountry, String playerType, String playerAge, String playerMatchPlayed, String playerGoals, String playerYellowCards, String playerRedCards) {
        super();
